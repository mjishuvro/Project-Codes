...
spatial_reference = r"E:\Script\Flood_Map_from_HD_Node_Data\Input_Data\BTM.prj"

# Setting the sheet name in xls file from which shape file will be created
sheet_name = "Sheet1"

# Setting the output shape file folder
output_folder_path = r"E:\Script\Flood_Map_from_HD_Node_Data\Output\Shape_File"

# Iterating through the folder and creating shape file from xls file
for excel_file in glob.glob(r"E:\Script\Flood_Map_from_HD_Node_Data\Output\WL\*.xls"):
    ...
    in_table = r"{}\{}.dbf".format(output_folder_path, 'Water_Level_Data')
    x_coordinate = "BTM_X"
    y_coordinate = "BTM_Y"
